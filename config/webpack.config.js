  ...
  return {
    ...
    output: {
      ...
      filename: isEnvProduction
        ? 'static/js/[name].[contenthash:8].js?v=' + times
        : isEnvDevelopment && 'static/js/bundle.js?v=' + times,
      // TODO: remove this when upgrading to webpack 5
      futureEmitAssets: true,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? 'static/js/[name].[contenthash:8].chunk.js?v=' + times
        : isEnvDevelopment && 'static/js/[name].chunk.js?v=' + times,
